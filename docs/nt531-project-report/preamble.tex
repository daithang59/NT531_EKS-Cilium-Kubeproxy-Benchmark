...
\usepackage{iftex}
\ifPDFTeX
  \usepackage[T5]{fontenc}      % Hỗ trợ font tiếng Việt khi dùng pdfLaTeX
  \usepackage[utf8]{inputenc}   % Hỗ trợ gõ Unicode UTF-8 khi dùng pdfLaTeX
\fi
...
\usepackage{tikz}             % Vẽ sơ đồ minh họa trực tiếp bằng LaTeX
\usetikzlibrary{arrows.meta, positioning, fit, calc, backgrounds, shapes.geometric}
\tikzset{
    ntbox/.style={draw, rounded corners=2pt, align=center, inner sep=5pt, font=\small, fill=gray!8},
    ntfocus/.style={draw, rounded corners=2pt, align=center, inner sep=5pt, font=\small\bfseries, fill=blue!8},
    ntwarn/.style={draw, rounded corners=2pt, align=center, inner sep=5pt, font=\small, fill=orange!12},
    ntarrow/.style={-{Latex[length=2.2mm]}, thick}
}
...
\usepackage[scaled=0.95]{inconsolata} % Font monospace dễ đọc hơn cho code
...
\usepackage{csquotes}         % Hỗ trợ trích dẫn cho biblatex
\usepackage[backend=biber,style=numeric,sorting=none,url=true,doi=false,eprint=false,isbn=false]{biblatex}
